...
_launchURL() async {
  const url = 'https://gaana.com/playlist/tanmay5709-gannacom';
...
class _LocalAudio extends State<LocalAudio> {
  ...
  Widget LocalAudio() {
    return _tab([
      _btn('Play', () => audioCache.play('soft.mp3')),
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(     // for enabling the control over the tabs
      length: 1,
      child: Scaffold(
        floatingActionButton: FloatingActionButton.extended(
          onPressed: _launchURL,
          label: Text("ganna.com"),
